...
// const myEngine = new QueryEngine(); // program breaks on this!!!
...
function App() {
  ...
  async function handleWtkURIValidate(){ // this won't work because of comunica :s
    console.log("debug: Pressing handleWtkURIValidate");
